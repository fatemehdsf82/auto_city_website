...
class Product(models.Model):
    ...
    product_cost = models.IntegerField(name="cost")
    product_category = models.CharField(max_length=40,choices=CATEGORY_CHOICES,name="category")
    product_brand = models.CharField(max_length=40,choices=BRAND_CHOICES,default='blank',name="brand")
